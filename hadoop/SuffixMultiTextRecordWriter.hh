...
#ifndef _HADOOP_HCE_SUFFIX_MULTI_TEXT_RECORDWRITER_H_
#define _HADOOP_HCE_SUFFIX_MULTI_TEXT_RECORDWRITER_H_
...
namespace HCE
{
	class SuffixLineRecordWriter;
	
    class SuffixMultiTextRecordWriter
	    : public RecordWriter {
	public:
		...
		~SuffixMultiTextRecordWriter(){}

	protected:
		bool checkSpec(const void* value, uint64_t valueLen);
	private:
	    map<string, SuffixLineRecordWriter*> _writers;
